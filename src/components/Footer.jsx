...
export default function Footer(props) {
  return (
    <div className={`${props.mode === "dark"
      ? "bg-[#080321]"
      : "bg-white"}`}>
      <div className="container mx-8 pt-[120px]">
        <div className="flex flex-wrap">
          {/* Logo + Description + Social Links */}
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-4/12">
            <div className="mb-14 max-w-[330px] xl:mb-20">
              <a href="/" className="mb-6 inline-block">
                <img
                  src={props.mode === "dark" ? `${process.env.PUBLIC_URL}/logo-light.svg` : `${process.env.PUBLIC_URL}/logo-dark.svg`}
                  alt="Site Logo"
                  className="h-12 w-auto transition duration-300"
                />
              </a>
              <p className={`mb-10 text-base font-medium ${props.mode === "dark"
                ? "text-[#b5b3bc]"
                : "text-[#637381]"}`}>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-2/12">
            <div className="mb-14 xl:mb-20">
              <h4 className={`mb-5 text-2xl font-bold ${props.mode === "dark"
                  ? "text-white"
                  : "text-black"}`}>
                Quick Links
              </h4>
              <div className="space-y-3">
                {[
                  ...
                  <a
                    key={item}
                    href="#"
                    className={`block text-base font-medium hover:text-[#3e7dff] ${props.mode === "dark"
                  ? "text-[#b5b3bc]"
                  : "text-[#637381]"}`}
                  >
                    {item}
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/2 xl:w-4/12">
            <div className="wow fadeInUp mb-14 xl:mb-20" data-wow-delay="0s">
              ...
              <div className="space-y-3">
                {/* Post 1 */}
                <div className="flex">
                  <div className="relative mr-5 h-[75px] w-full max-w-[75px] rounded-md">
                    <a
                      className="block"
                      href="laboris-nisi-aliquip-dium-exiuliym-commo-cons"
                    >
                      <img
                        alt="blog"
                        loading="lazy"
                        decoding="async"
                        className="h-20 w-24 rounded-md object-cover object-center"
                  ...
                  <div>
                    <a
                      className={`text-base font-medium hover:text-[#3e7dff] ${props.mode === "dark"
                  ? "text-[#b5b3bc]"
                  : "text-[#637381]"}`}
                      href="laboris-nisi-aliquip-dium-exiuliym-commo-cons"
                    >
                    ...
                    <a
                      ...
                      href="/blog/laboris-nisi-aliquip-dium-exiuliym-commo-cons"
                    >
                      <span className={`pr-1 ${props.mode === "dark"
                  ? "text-[#b5b3bc]"
                  : "text-[#637381]"}`}>
                        <svg
                          width="14"
                      ...
                      <span className={`text-sm font-medium ${props.mode === "dark"
                  ? "text-[#b5b3bc]"
                  : "text-[#637381]"}`}>
                        Aug 21 2024
                      </span>
                ...
                <div className="flex">
                  <div className="relative mr-5 h-[75px] w-full max-w-[75px] rounded-md">
                    <a
                      className="block"
                      href="/blog/expenses-as-material-bre-mate-insisted-building"
                    >
                      <img
                        alt="blog"
                        loading="lazy"
                        decoding="async"
                        className="h-20 w-24 rounded-md object-cover object-center"
                        src="https://cdn.sanity.io/images/d33zuypx/production/dbd12e983d6827bf7923b41d837d298c0aefcd9e-740x340.jpg"
                      />
                    </a>
                  </div>
        ...
        <div className={`border-t py-7 text-center ${props.mode === "dark"
                  ? "border-[#2D2C4A]"
                  : "border-[#F3F4F4]"}`}>
          <p className={`text-base font-medium leading-loose ${props.mode === "dark"
                  ? "text-[#b5b3bc]"
                  : "text-[#637381]"}`}>
            © <span className="font-semibold text-primary">Crypto</span> – All Rights Reserved, Crafted by{" "}
            <span className="font-semibold text-primary">Next.js Templates</span>
          </p>
        </div>
      </div>
    </div>
