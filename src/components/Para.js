...
export default function Para(props) {
    return (
        <div className=" pt-26 font-Inter">
      ...
      >
            {/* Heading */}
            <h1 className={`mx-auto text-center max-w-[740px] mb-4 text-[45px] font-bold leading-tight ${props.mode === "dark"
                ? "text-white"
                : "text-dark"}`}>
                Next.js Template and Boilerplate for Crypto, ICO and Web3
            </h1>
            {/* Paragraph */}
            <p className={`mx-auto text-center text-[#637381] mb-4 max-w-[590px] text-lg font-medium  ${props.mode === "dark"
                ? "text-white"
                : "text-dark"}`}>
                A Next.js website tem~plate for Crypto Currency, Blockchain, ICO, and Web3, meticulously styled with Tailwind CSS. This boilerplate includes essential integrations, UI components, pages, and enabling you to launch a comprehensive website or landing page for anything related to Crypto, Blockchain, and Web3.
            </p>                                                                                                                                                                                                                                
            ...
            <div className=" mb-10 flex flex-wrap items-center justify-center">
                ...
                <div className="group relative mt-4 px-1 sm:px-2">
                    <span className="mt-2 flex h-10 w-10 items-center justify-center rounded-full bg-white">
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="14.28" cy="14.28" r="14.28" fill="#24292F"></circle>
                ...
                <div className="group relative mt-4 px-1 sm:px-2">
                    <span className="mt-2 flex h-10 w-10 items-center justify-center rounded-full bg-white">
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="14.28" cy="14.28" r="14.28" fill="#1181E7"></circle>
                            ...
                            <g clipPath="url(#clip0_73_10312)"><path d="M13.9982 6.12451L13.8926 6.48343V16.8976L13.9982 17.003L18.8323 14.1456L13.9982 6.12451Z" fill="#D6D6D6"></path><path d="M13.9982 6.12451L9.16406 14.1456L13.9982 17.003V11.9483V6.12451Z" fill="white"></path><path d="M13.998 17.9175L13.9385 17.9901V21.6998L13.998 21.8736L18.835 15.0615L13.998 17.9175Z" fill="#D6D6D6"></path><path d="M13.9982 21.8736V17.9175L9.16406 15.0615L13.9982 21.8736Z" fill="white"></path><path d="M13.998 17.0025L18.8321 14.1451L13.998 11.9478V17.0025Z" fill="#F3F3F3"></path><path d="M9.16406 14.1451L13.9982 17.0025V11.9478L9.16406 14.1451Z" fill="#E2E2E2"></path></g>
                            <defs><clipPath id="clip0_73_10312"><rect width="15.749" height="15.749" fill="white" transform="translate(6.125 6.12451)"></rect></clipPath></defs>
                        </svg>
                    </span>
                    <div className="absolute -top-full left-1/2 z-50 -translate-x-1/2 whitespace-nowrap rounded-full bg-[#2D2C4A] px-5 py-2 text-white opacity-0 group-hover:opacity-100 transition">
                        <span className="absolute -bottom-1 left-1/2 h-3 w-3 -translate-x-1/2 rotate-45 bg-[#2D2C4A]"></span>
                ...
                <div className="group relative mt-4 px-1 sm:px-2">
                    <span className="mt-2 flex h-10 w-10 items-center justify-center rounded-full bg-white">
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="14.28" cy="14.28" r="14.28" fill="#8247E5"></circle>
                            ...
                            <defs><clipPath id="clip0_73_10294"><rect width="14" height="12.6" fill="white" transform="translate(7 7)"></rect></clipPath></defs>
                        </svg>
                    </span>
                    <div className="absolute -top-full left-1/2 z-50 -translate-x-1/2 whitespace-nowrap rounded-full bg-[#2D2C4A] px-5 py-2 text-white opacity-0 group-hover:opacity-100 transition">
                        <span className="absolute -bottom-1 left-1/2 h-3 w-3 -translate-x-1/2 rotate-45 bg-[#2D2C4A]"></span>
                ...
                <div className="group relative mt-4 px-1 sm:px-2">
                    <span className="mt-2 flex h-10 w-10 items-center justify-center rounded-full bg-white">
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="14.28" cy="14.28" r="14.28" fill="#F14E51"></circle>
            ...
            <div className=' mx-auto text-center max-w-[740px]'>
                <a className="bg-[#3e7dff] hover:bg-[#6A9EFF] rounded-full px-8 py-3 font-semibold text-white" href="#" role="button">Buy Tokens 47% Off</a>
            </div>
            </motion.div>
                </div>
            <div
      ...
      >
            <div className="container mx-auto px-4 pt-32">
                <div style={{ opacity: 1, transform: "none" }}>
                    <div className={`border-y pt-10 ${props.mode === "dark"
                        ? "text-white border-[#2D2C4A]"
                        : "text-dark  border-[#F3F4F4]"}`}>
                        <h2 className={`mb-10 text-center text-lg font-bold text-black sm:text-2xl  ${props.mode === "dark"
                            ? "text-white "
                            : "text-dark"}`}>
                            ...
                            <div className="px-4">
                                <div className="mb-5 text-center">
                                    <a
                                        ...
                                        className="mb-10 flex max-w-[170px] justify-center opacity-70 grayscale hover:opacity-100 hover:grayscale-0"
